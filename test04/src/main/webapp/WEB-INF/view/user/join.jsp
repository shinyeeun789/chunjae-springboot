...
<div class="l-content" style="width:1280px;margin:20px auto;">
    <h2>회원 가입</h2>
    <form class="pure-form pure-form-aligned" action="${path0}/joinPro.do" method="post" onsubmit="return joinConfirm(this)">
        <fieldset>
            ...
            <div class="pure-control-group">
                ...
                <button type="button" id="emailCheckBtn" onclick="emailCheckConfirm()" class="pure-button pure-button-primary" >이메일 중복 체크</button>
    ...
    <script>
        $(document).ready(function(){
            $("#idCheckBtn").click(function(){
                ...
                var params = {	name : $("#id").val()	} //전송되어질 데이터를 객체로 묶음
                $.ajax({
                    url:"${path1 }/idCheck.do",	//아이디가 전송되어질 곳
                    type:"post",		//전송방식
            ...
            $("#emailCheckBtn").click(function(){
                ...
                $.ajax({
                    url:"${path1 }/emailCheck.do",	//아이디가 전송되어질 곳
                    type:"post",		//전송방식
                    dataType:"json",	//데이터 반환 방식
                    data:params,		//전송방식이 post인 경우 객체로 묶어서 전송
                    success:function(result){
