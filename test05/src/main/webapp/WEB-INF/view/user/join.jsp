...
<div>
    <div class="container mt-3">
        ...
        <div class="container mt-3">
            <form action="${path}/user/join.do" method="post" onsubmit="return joinCheck()">
                <label for="name" class="form-label"> 아이디 </label>
                <div class="d-flex justify-content-between">
                    <input type="text" id="name" class="form-control w-75" placeholder="아이디를 입력하세요">
                    <button class="btn btn-primary w-25"> 중복체크 </button>
                </div>
                ...
                <label for="passwordChk" class="form-label mt-3"> 비밀번호 확인 </label>
                <input type="password" id="passwordChk" class="form-control" placeholder="비밀번호 확인을 입력하세요">
                ...
                <input type="text" id="tel" class="form-control" placeholder="전화번호를 입력하세요">
